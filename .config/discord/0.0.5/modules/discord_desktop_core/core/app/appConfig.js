...
function init() {
  ...
  _ipcMain2.default.on('TOGGLE_MINIMIZE_TO_TRAY', function (_event, value) {
    return setMinimizeOnClose(value);
  });
  _ipcMain2.default.on('TOGGLE_OPEN_ON_STARTUP', function (_event, value) {
    return toggleRunOnStartup(value);
  });
  _ipcMain2.default.on('TOGGLE_START_MINIMIZED', function (_event, value) {
