...
function webContentsSend() {
  if (mainWindow != null && mainWindow.webContents != null) {
    ...
    (_mainWindow$webConten = mainWindow.webContents).send.apply(_mainWindow$webConten, ['DISCORD_' + event].concat(_toConsumableArray(options)));
  }
}
...
function setupUpdaterIPC() {
  ...
  _ipcMain2.default.on(_Constants.UpdaterEvents.CHECK_FOR_UPDATES, function () {
  ...
  _ipcMain2.default.on(_Constants.UpdaterEvents.QUIT_AND_INSTALL, function () {
    saveWindowConfig(mainWindow);
    mainWindow = null;
    moduleUpdater.quitAndInstallUpdates();
  });

  _ipcMain2.default.on(_Constants.UpdaterEvents.MODULE_INSTALL, function (_event, name, options) {
    moduleUpdater.install(name, false, options);
  });

  _ipcMain2.default.on(_Constants.UpdaterEvents.MODULE_QUERY, function (_event, name) {
...
function handleSingleInstance(args) {
  if (mainWindow != null) {
    var appPath = extractPathFromArgs(args);
    if (appPath != null) {
